...
public function getStudents(){
    ...
    public function update(){
        $sql = "UPDATE student_info SET student_id='".$this->student_id."',name='".$this->name."',father_name='".$this->father_name."',mother_name='".$this->mother_name."',email='".$this->email."',phone='".$this->phone."',address='".$this->address."' WHERE id='".$this->id."'";
        $save = $this->db->exec($sql);
        return $save ? true : false;
    }
